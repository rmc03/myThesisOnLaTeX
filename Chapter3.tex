...
Para su realización se tomó una muestra de estudiantes de la Escuela Primaria ``José Martí'' de La Habana, con edades comprendidas entre 8 y 10 años, a los que se les distribuyó el videojuego \textit{Go Goals! Digital} sin manual ni explicaciones de cómo jugar, para probar la utilidad de los tutoriales dentro del videojuego y la intuitividad de la interfaz.
...
\hline
Javier Ernesto Perdomo Batista & 10 \\
\hline
Yslen Marturelo Lorenzo & 8 \\
\hline
Janys Lourdes Cañizares de la Rosa & 10 \\
\hline
Pedro Luis Hernández Soto & 9 \\
\hline
Sofía Martínez Delgado & 10 \\
\hline
Carlos Alberto Ramos Pérez & 8 \\
\hline
Daniela Fernández Suárez & 9 \\
\hline
\end{tabular}
\end{table}
