...
Para su realización se tomó una muestra de jóvenes estudiantes de La Habana, con edades comprendidas entre 15 y 25 años, a los que se les distribuyó el videojuego \textit{Go Goals! Digital} sin manual ni explicaciones de cómo jugar, para probar la utilidad de los tutoriales dentro del videojuego y la intuitividad de la interfaz.
...
Para la aplicación de esta prueba se contó con la misma muestra de participantes que intervino en las pruebas beta. A dicha muestra se le administró un cuestionario estructurado, elaborado y diseñado específicamente para evaluar los criterios de aceptación, el cual presentó la siguiente estructura:
...
Tomando estos resultados se aplica la fórmula del índice de satisfacción del cliente (CSAT, por sus siglas en inglés), donde se divide el número de respuestas positivas entre el total de respuestas y se multiplica por 100. Al aplicar esta métrica se obtiene un cociente de 108 respuestas positivas divididas entre 110 respuestas totales que, al ser multiplicado por 100, resulta en un índice de satisfacción del 98.18\%; un valor que se considera extremadamente alto y que valida objetivamente la calidad técnica, el diseño instruccional y la aceptación del videojuego educativo \textit{Go Goals! Digital} por parte de su público objetivo.

%---------------------------------------------------------------------------
\section*{Conclusiones del capítulo}

El diseño estructurado de la validación permitió asegurar una alta calidad en el proceso evaluativo, adhiriéndose a las buenas prácticas estandarizadas por la metodología Extreme Programming. A través de la aplicación de pruebas unitarias automatizadas se garantizó el correcto funcionamiento de los módulos lógicos internos sin dependencias externas, previniendo defectos de integración. Por su parte, la ejecución de las pruebas de aceptación con una muestra representativa validó al videojuego en su totalidad desde la perspectiva pragmática de los usuarios finales. Finalmente, el índice de aceptación del 98.18\% documentado mediante el instrumento CSAT constata de manera fehaciente que \textit{Go Goals! Digital} cumple satisfactoriamente con los objetivos pedagógicos y lúdicos planteados, resultando en un producto tecnológico altamente valorado por su público objetivo.
